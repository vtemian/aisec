...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NoticeType.slug'
        db.add_column('notification_noticetype', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NoticeType.slug'
        db.delete_column('notification_noticetype', 'slug')
